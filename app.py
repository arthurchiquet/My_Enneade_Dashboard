                    ...
                    navBarContents = [
                        dbc.Row(
                            ...
                            children=[
                                ...
                                dbc.Button(
                                    "Profil", color="dark", className="mr-1", href="/profil"
                                ),
                                dbc.Button(
                                    "Admin",
                                    id="profil",
                    ...
                    navBarContents = [
                        dbc.Row(
                            ...
                            children=[
                                ...
                                html.A(
                                    html.Img(
                                        src=app.get_asset_url("chantier.webp"),
                                        height="30px",
                                    ),
                                    href="/chantier",
                                ),
                                html.A(
                                    html.Img(
                                        src=app.get_asset_url("import.png"), height="30px"
                                    ),
                                    href="/export",
                                ),
                                html.A(
                                    html.Img(
                                        src=app.get_asset_url("profil.png"), height="30px"
                                    ),
                                    href="/profil",
                                ),
                                html.A(
                                    html.Img(
                                        src=app.get_asset_url("logout.png"), height="30px"
                                    ),
                                    href="/logout",
                                ),
                            ],
